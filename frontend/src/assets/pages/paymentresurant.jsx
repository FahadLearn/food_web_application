        ...
        <table className="mt-[20px] w-[100%] bg-gray-200 border-gray-500 border-2">
          <thead>
            <tr className="bg-amber-500 text-white font-lighter ">
              <th className="w-[10%] border-2 border-gray-500">Payment ID</th>
              <th className="w-[12%]  border-2 border-gray-500">Order ID</th>
              <th className="w-[25%]  border-2 border-gray-500">Name</th>
              <th className="w-[10%]  border-2 border-gray-500">
                Payment Method
              </th>
              <th className="w-[10%]  border-2 border-gray-500">Amount</th>
          ...
          <tbody>
            {payment.map((item) => (
              <PaymentAdmin key={item.paymentId} data={item} />
            ))}
          </tbody>
        </table>
      </div>
